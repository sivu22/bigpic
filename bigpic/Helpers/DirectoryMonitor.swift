...
/*  Modified by Cristian Sava on 28.09.20.
    Update the code to Swift 5 */
...
class DirectoryMonitor {
    ...
    let directoryMonitorQueue = DispatchQueue(label: "apple.directorymonitor", attributes: .concurrent)
